    ...
    />
          ...
          <div className="flex gap-4 mt-5">
            <a
              ...
              className="text-slate-500 hover:text-blue-brand transition-colors"
            >
        ...
        <div>
          ...
          <ul className="space-y-3" role="list">
            <li><a href="#products" className="text-slate-400 text-sm hover:text-blue-brand transition-colors cursor-pointer">All Products</a></li>
            <li><a href="#story" className="text-slate-400 text-sm hover:text-blue-brand transition-colors cursor-pointer">Our Story</a></li>
            <li><a href="#contact" className="text-slate-400 text-sm hover:text-blue-brand transition-colors cursor-pointer">Contact & Location</a></li>
          </ul>
        </div>
